...
const normalizePath = (pathToFile) => path.resolve(isAbsolute(pathToFile) ? pathToFile : `${process.cwd()}/${pathToFile}`);
...
const buildFieldDiff = (fieldName, oldValue, newValue, status) => ({ fieldName, oldValue, newValue, status });
